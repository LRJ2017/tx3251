...
#ifdef CGICDEBUG
		CGICDEBUGSTART
		fprintf(dout, " submit upload file name :%s \n", n->tfileName);
		CGICDEBUGEND
#endif
...
#ifdef CGICDEBUG
	CGICDEBUGSTART
	fprintf(dout, "cgiFormFileName fileName:%s \n", s);
	CGICDEBUGEND
#endif
...
#ifdef CGICDEBUG
	CGICDEBUGSTART
	fprintf(dout, "cgiFormFileName result:%s \n", result);
	CGICDEBUGEND
#endif
...
#ifdef CGICDEBUG
		CGICDEBUGSTART
		fprintf(dout, "cgiFormSelectSingle:cgiFormNotFound \n");
		CGICDEBUGEND
#endif
...
#ifdef CGICDEBUG
	CGICDEBUGSTART
	fprintf(dout, "cgiFormEntryFindFirst: %s \n", name);
	CGICDEBUGEND
#endif
...
#ifdef CGICDEBUG
		CGICDEBUGSTART
		fprintf(dout, "cgiFormEntryFindNext: %s %s \n", c -> attr, cgiFindTarget);
		CGICDEBUGEND
#endif
